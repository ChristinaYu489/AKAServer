...
@Component({
  selector: 'app-quiz-level10',
  templateUrl: './quiz-level10.component.html',
  styleUrls: ['./quiz-level10.component.css']
})
export class QuizLevel10Component implements OnInit {
  ...
  ngOnInit() {
    ...
    quizContentHandler.generateQuizList(10);
